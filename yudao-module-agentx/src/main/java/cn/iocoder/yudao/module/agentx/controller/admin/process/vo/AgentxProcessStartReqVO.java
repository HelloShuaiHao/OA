...
@Schema(description = "管理后台 - AgentX 流程启动 Request VO")
@Data
public class AgentxProcessStartReqVO {

    @Schema(description = "Agent ID", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "agentId 不能为空")
    private Long agentId;

    @Schema(description = "业务键", requiredMode = Schema.RequiredMode.REQUIRED)
